...
public class ApiConstants {
    ...
    public static final String USER_BASIC_PATH = "/users";

    public static final String USERS_V1 = ROOT_API_V1 + USER_BASIC_PATH;
    ...
    public static final String RESOURCE_ALBUMS_USER_SESSION = USER_BASIC_PATH;
    public static final String RESOURCE_PHOTOS_USER_SESSION = USER_BASIC_PATH;
